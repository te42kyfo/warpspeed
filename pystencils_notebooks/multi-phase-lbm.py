...
dh = ps.create_data_handling(
    (domain_size), periodicity=(True, True, True), parallel=False, default_target=target
)
...
ast_hydro_lb = ps.create_kernel(
    hydro_lb_update_rule, target=dh.default_target, cpu_openmp=True
)
...
def get_hydro_lb_ast(bock_size):
    return ps.create_kernel(
